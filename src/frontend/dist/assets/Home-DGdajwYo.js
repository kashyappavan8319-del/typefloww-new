import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, u as useNavigate, a as useStreak, b as useLocalStorage, B as Button, d as cn, e as Badge, F as Flame } from "./index-B1Z6BCCy.js";
...
const MODE_CARDS = [
  {
    ...
    description: "Train with real-world passages. Choose your difficulty from beginner (level 1) to expert (level 10).",
    badge: "Levels 1–10",
  ...
  },
  {
    ...
    description: "Practice with realistic Hinglish & English chat messages. Type like you actually talk.",
    badge: "Hinglish",
  ...
  },
  {
    ...
    icon: CodeXml,
    title: "Coding Mode",
    description: "Master symbols like {}, [], </>, () and indentation. Build real coding muscle memory.",
    badge: "Syntax",
...
const FEATURE_PILLS = [
  ...
  { icon: ChartNoAxesColumn, label: "10 difficulty levels" }
];
function StatCard({
  icon: Icon,
  label,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-body uppercase tracking-widest text-muted-foreground leading-none", children: label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl sm:text-3xl font-display font-bold text-foreground leading-none mt-1", children: value }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-body text-muted-foreground", children: sub })
      ]
    }
  );
}
function HomePage() {
  ...
  const [sessions] = useLocalStorage("typeflow-sessions", []);
  const totalSessions = sessions.length;
  const bestWpm = sessions.length > 0 ? Math.max(...sessions.map((s) => s.wpm)) : 0;
  function goToPractice(mode) {
    navigate({ to: "/practice", search: { mode } });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "home.page", className: "flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "flex flex-col items-center justify-center px-4 pt-14 pb-8 sm:pt-20 sm:pb-10 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center flex-wrap gap-2 mb-6", children: FEATURE_PILLS.map(({ icon: Icon, label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-3 h-3 text-primary" }),
                label
              ]
            },
            label
          )) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground tracking-tight leading-[1.1] mb-4", children: [
            "Type better.",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Feel faster." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base sm:text-lg text-muted-foreground max-w-sm mx-auto leading-relaxed mb-8", children: "A calm, premium typing experience built for real-life practice — not rigid drills." }),
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-xl sm:text-2xl text-foreground mb-1", children: "Choose your mode" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground", children: "Three distinct experiences, each tuned for a different typing goal." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-3", children: MODE_CARDS.map((card, index) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.button,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground text-sm mb-1.5 leading-tight", children: card.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-muted-foreground leading-relaxed mb-4", children: card.description }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      className: cn(
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto", children: [
          ...
          totalSessions === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.p,
            {
              ...
              children: "Complete your first session to start tracking progress."
            }
          )
        ] })
      }
